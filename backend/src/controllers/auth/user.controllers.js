...
const options = {
  ...
  sameSite: process.env.NODE_ENV === 'production' ? 'strict' : 'lax', // SameSite attribute to prevent CSRF attacks
  path: '/', // Set path explicitly
};
...
const userLogout = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .clearCookie('accessToken', { ...options, maxAge: undefined })
    .clearCookie('refreshToken', { ...options, maxAge: undefined })
